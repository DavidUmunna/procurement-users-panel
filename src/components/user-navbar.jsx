              ...
              >
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="-mr-2 flex md:hidden">
                    <Link className="inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
